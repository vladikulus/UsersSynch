...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('userssynch_core_path', null,
                    $modx->getOption('core_path') . 'components/userssynch/') . 'model/';
            $modx->addPackage('userssynch', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/userssynch/model/schema/userssynch.mysql.schema.xml';
